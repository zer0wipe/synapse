...
export class SynapseSettingTab extends PluginSettingTab {
	...
	display(): void {
        ...
        new Setting(containerEl)
            ...
            .setDesc('Enter your Ollama API endpoint URL. Default is http://localhost:11434')
            .addText(text => {
        ...
        new Setting(containerEl)
            ...
            .setDesc('Select the API provider for the Large Language Model. Currently only Ollama is supported.')
