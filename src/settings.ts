...
export interface SynapseSettings {
    // The API key for the chosen LLM provider (e.g., Gemini).
    geminiApiKey: string;
    ...
    model: string;
    // The name of the LLM model to use specifically for generating note titles.
    titleModel: string;
...
export class SynapseSettingTab extends PluginSettingTab {
	...
	display(): void {
        ...
        new Setting(containerEl)
            ...
            .setDesc('Select the API provider for the Large Language Model. Currently only Gemini is supported.')
            .addDropdown(dropdown => dropdown
                .addOption('Gemini', 'Gemini') // Only Gemini option available for now.
        ...
        new Setting(containerEl)
            ...
            .setDesc('The LLM model to use for generating the main content of responses.')
            .addText(text => text
        ...
        new Setting(containerEl)
            ...
            .setDesc('The folder where new conversation notes will be created. If left empty, notes will be created in the same folder as the source note.')
            .addText(text => text
        ...
        new Setting(containerEl)
            ...
            .setDesc('How many levels of backlinks to traverse to build the conversation history for the LLM. A higher number provides more context but may increase processing time.')
        ...
        const systemPromptSetting = new Setting(containerEl)
            ...
            .setDesc('Define the system prompt for the AI assistant. This sets the AI\'s persona, tone, and core instructions for generating responses.');
